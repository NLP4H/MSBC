...
if __name__ == "__main__":
    prediction_col = "score_sensory_subscore"
    config = Params.from_file('master_path/master/ML4H_MSProject/task1/configs/cnn_encoder_score_sensory_subscore_config.jsonnet')
