...
if __name__ == "__main__":
    prediction_col = "score_brain_stem_subscore"
    config = Params.from_file('master_path/master/ML4H_MSProject/task1/configs/cnn_encoder_score_brain_stem_subscore_config.jsonnet')
