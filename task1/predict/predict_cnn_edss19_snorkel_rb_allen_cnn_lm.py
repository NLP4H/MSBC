...
if __name__ == "__main__":
    ...
    config = Params.from_file('master_path/master/ML4H_MSProject/task1/configs/predict_cnn_encoder_edss19_snorkel_rb_allen_cnn_lm_config.jsonnet')
    ...
    output_file = "master_path/results/task2/predictions_"+prediction_col+"snorkel_rb_allen_cnn.csv"
    embeddings_file = "master_path/results/task2/embeddings_"+prediction_col+"snorkel_rb_allen_cnn.csv"
    ...
    with open(output_file, 'w') as out_file:
        with open(embeddings_file, 'w') as embed_file:
            out_file.write("patient_id,date,split,"+prediction_col+",predicted_"+prediction_col+"snorkel_rb_allen_cnn\n")
            embed_file.write("patient_id,date,split,text,embeddings_"+prediction_col+"snorkel_rb_allen_cnn\n")
            print("Train Data")
