...
if __name__ == "__main__":
    prediction_col = "ms_type"
    config = Params.from_file('master_path/master/ML4H_MSProject/task1/configs/cnn_encoder_ms_type_config.jsonnet')
        ...
        with open(embeddings_file, 'w') as embed_file:
            ...
            for i, row in df.iterrows():
                ...
                if row["tokenized_text"] == "[101, 102]":
                    output = {"embeddings": [0.0]*768, "label": "NA"}
                    truth = "NA"
                    text = "\"\""
                else:
