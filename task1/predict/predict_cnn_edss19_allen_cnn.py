...
if __name__ == "__main__":
    ...
    config = Params.from_file('master_path/master/ML4H_MSProject/task1/configs/predict_cnn_encoder_edss_19_allen_cnn_config.jsonnet')
    ...
    output_file = "master_path/results/task2/predictions_"+prediction_col+"_allen_cnn.csv"
    embeddings_file = "master_path/results/task2/embeddings_"+prediction_col+"_allen_cnn.csv"
