local experiment_name = "cnn_edss_19_allen_cnn";
...
{	"train_options": { 
	...
	"params":{
	"dataset_reader": {
            "type": "data_scripts.datasetreaders.ms_predict_edss_19_allen_cnn_reader",
            // "tokenizer": {
        ...
        "train_data_path": "master_path/snorkel/train.csv",
        "validation_data_path": "master_path/snorkel/val.csv",
        "test_data_path": "master_path/snorkel/test.csv",
        "model": {
            ...
            "dropout": 0.1,
            "label_namespace": "predict_edss_19_allen_cnn_labels"
        },
        "data_loader": {
            "batch_sampler": {
                "type": "bucket",
