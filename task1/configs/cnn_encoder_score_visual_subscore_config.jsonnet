local experiment_name = "cnn_score_visual_subscore";
...
{	"train_options": { 
	...
	"params":{
	"dataset_reader": {
            "type": "data_scripts.datasetreaders.ms_score_visual_subscore_reader",
            // "tokenizer": {
        ...
        "model": {
            ...
            "dropout": 0.1,
            "label_namespace": "score_visual_subscore_labels"
        },
        "data_loader": {
            "batch_sampler": {
                "type": "bucket",
