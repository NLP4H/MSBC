local experiment_name = "cnn_score_sensory_subscore";
...
{	"train_options": { 
	...
	"params":{
	"dataset_reader": {
            "type": "data_scripts.datasetreaders.ms_score_sensory_subscore_reader",
            // "tokenizer": {
        ...
        "model": {
            ...
            "dropout": 0.1,
            "label_namespace": "score_sensory_subscore_labels"
        },
        "data_loader": {
            "batch_sampler": {
                "type": "bucket",
